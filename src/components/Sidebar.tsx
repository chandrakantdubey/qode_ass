...
const Sidebar = ({ isOpen, onClose }: SidebarProps) => {
    ...
    return (
        <>
            ...
            <div className={`h-screen w-64 bg-white text-slate-900 flex flex-col fixed left-0 top-0 border-r border-slate-200 z-50 transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
                }`}>
